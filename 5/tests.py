...
class AllChecks(unittest.TestCase):
    host = "localhost"
    port = 8080
    ...
    def test_server_header(self):
        ...
        self.conn.request("HEAD", "/httptest/")
    ...
    def test_file_with_query_string_two(self):
    ...
    def test_head_method(self):
        ...
        while 1:
            ...
            data += buf
        s.close()
        self.assertTrue(b"\r\n\r\n" in data, "no empty line with CRLF found")
        data = data.decode()
        head, body = re.split("\r\n\r\n", data, 1)
        headers = head.split("\r\n")
...
a = loader.loadTestsFromTestCase(AllChecks)
suite.addTest(a)
